...
public class TclShellLocal extends TclShellImpl {
	...
	public void launch() throws IOException {
		p = Runtime.getRuntime().exec(shellName, null, dir);
	...
	public synchronized void executeCommand(ShellCommand command) {
		...
		Pattern p = Pattern.compile("stdout: <(.*)>\r\nreturn value:", Pattern.DOTALL);
		...
		p = Pattern.compile("return value: <(.*)>\r\nerrorCode:", Pattern.DOTALL);
